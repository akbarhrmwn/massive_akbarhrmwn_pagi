      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen">
          ...
          <motion.div variants={fadeIn('left', 0.5)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className="flex-1">
            ...
            <h3 className="h3 mb-4">Saya adalah seorang mahasiswa dari Kampus Bina Sarana Informatika</h3>
            <p className="mb-6">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolor natus omnis inventore quas beatae illo nulla. Officiis magni omnis molestias.</p>
            {/* stats */}
